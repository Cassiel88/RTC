...
@pytest.mark.parametrize("negative_input", ['Sergeryandex.ru', '@yandex.ru', 'Sergkser@', 'Sergk..ser@yandex.ru', '.Sergser@yandex.ru', 'sergser@.yandex.ru.'], ids=['отсутствие @ в email', 'отсутствие лок. части', 'отсутствие дом. части', 'содержит две точки подряд', 'лок. часть начинается и/или заканчивается с точки', 'дом. часть начинается и/или заканчивается с точки'])
